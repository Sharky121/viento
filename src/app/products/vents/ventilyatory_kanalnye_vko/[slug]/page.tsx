    ...
    return (
        <>
            <div className="page-main__content main-content">
                <a className="main-content__back" href='/products/vents/ventilyatory_kanalnye_vko' id="back-page">Назад</a>
                ...
                <section className="main-content__product product">
                    <div className="product__container">
                        <div className="product__image">
                            <Gallery images={productData.images} url={`/images/vents/ventilyatory_kanalnye_vko/${params.slug}`}/>
                        </div>
