    ...
    return (
        <>
            <div className="page-main__content main-content">
                <a className="main-content__back" href={`/products/sistemy_metallicheskikh_vozdukhovodov/`} id="back-page">Назад</a>
                ...
                <section className="main-content__product product">
                    <div className="product__container">
                        <div className="product__image">
                            <Gallery images={product.images} url={`/images/products/sistemy_metallicheskikh_vozdukhovodov/${params.slug}`}/>
                        </div>
