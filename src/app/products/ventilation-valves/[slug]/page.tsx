...
export default async function Page({ params }: { params: { slug: string } }) {
    ...
    const product = products.find((p: any) => slugify(p.title, '_') === params.slug);
    ...
    return (
        <>
            <div className="page-main__content main-content">
                <a className="main-content__back" href="/products/ventilation-valves">Назад</a>
                ...
                <section className="main-content__product product">
                    <div className="product__container">
                        <div className="product__image">
                            <Gallery images={product.images} url={`/images/products/ventilation-valves/${params.slug}`}/>
                        </div>
