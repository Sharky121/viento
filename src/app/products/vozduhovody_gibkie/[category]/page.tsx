...
async function getData() {
    const response = await fetch(`${process.env.HOST}/api/flexible-ducts`, {
        cache: 'no-store'
    });
    ...
    return (
        <>
            <div className="page-main__content main-content">
                <a className="main-content__back" href="/products/vozduhovody_gibkie">Назад</a>
                ...
                <section className="main-content__product product">
                    <div className="product__container">
                        <div className="product__image">
                            <Gallery images={product.images} url={`/images/products/vozduhovody_gibkie/${product.slug}`}/>
                        </div>
