...
export default async function Page({ params }: { params: ParamsType }) {
    ...
    const product = category.items.find((p: any) => p.slug === params.product);
    ...
    return (
        <>
            <div className="page-main__content main-content">
                <a className="main-content__back" href={`/products/reshetki_ventilyacionnye/${params.category}`}>Назад</a>
                ...
                <section className="main-content__product product">
                    <div className="product__container">
                        <div className="product__image">
                            <Gallery images={product.images} url={`/images/products/reshetki_ventilyacionnye/${params.category}/${params.product}`}/>
                        </div>
                        <div className="product__description product-description">
                            <h1 className="product-description__title">
                                ...
                                {product.colors.length !== 0 && (
                                    <span>Доступные цвета: {product.colors.join(', ') + '.'}
                                    </span>  
                                )}
                            </h1>
