    ...
    return (
        <>
            <div className="page-main__content main-content">
                <a className="main-content__back" href='/products/lyuki_revizionnye/lyuki_revizionnye_plastikovye/' id="back-page">Назад</a>
                ...
                <section className="main-content__product product">
                    <div className="product__container">
                        <div className="product__image">
                            <Gallery images={product.images} url={`/images/lyuki_revizionnye/lyuki_revizionnye_plastikovye/${params.slug}`}/>
                        </div>
