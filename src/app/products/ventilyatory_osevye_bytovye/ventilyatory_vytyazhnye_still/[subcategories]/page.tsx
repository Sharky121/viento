    ...
    return (
        <>
            <div className="page-main__content main-content">
                <a className="main-content__back" href='/products/ventilyatory_osevye_bytovye/ventilyatory_vytyazhnye_still/'>Назад</a>
                        ...
                        {productData.map(({id, title, slug}: { id: number, title: string, slug: string }) => (
                            <li key={id + uuidv4()} className="product-cards__item product-card">
                                ...
                                <div className="product-card__img">
                                    <Image src={`/images/ventilyatory_osevye_bytovye/ventilyatory_vytyazhnye_still/${params.subcategories}/${slug}/index.png`} width="180" height="180" alt="Фото продукта"/>
                                </div>
                    
                                <h3 className="product-card__title">{title}</h3>
                                <Link className="product-card__btn btn btn--outline" href={`/products/ventilyatory_osevye_bytovye/ventilyatory_vytyazhnye_still/${params.subcategories}/${slug}`}>Подробнее</Link>
                            </li>
                        ))} 
                    </ul>
                </section>
