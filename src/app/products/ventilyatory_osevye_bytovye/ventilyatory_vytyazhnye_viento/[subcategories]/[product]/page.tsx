    ...
    return (
        <>
            <div className="page-main__content main-content">
                <a className="main-content__back" href={`/products/ventilyatory_osevye_bytovye/ventilyatory_vytyazhnye_viento/${params.subcategories}`}>Назад</a>
                ...
                <section className="main-content__product product">
                    <div className="product__container">
                        <div className="product__image">
                            <Gallery images={productData.images} url={`/images/ventilyatory_osevye_bytovye/ventilyatory_vytyazhnye_viento/${params.subcategories}/${params.product}`}/>
                        </div>
